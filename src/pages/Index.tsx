  ...
  const features = [
    {
      ...
      description: "All transactions are secured and recorded on the blockchain for complete transparency"
    },
    {
      icon: Users,
      title: "Verified Users",
      description: "All donors and recipients are verified to prevent fraud and ensure trust"
    },
    {
      icon: Zap,
      title: "Instant Disbursement",
      description: "Smart contracts enable immediate fund release to verified recipients"
    },
    {
      icon: Globe,
      title: "Global Reach",
      description: "Connect with people worldwide to give and receive help across borders"
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
              Connect directly with people in need through our secure, blockchain-powered platform. 
              Every donation is transparent, traceable, and goes directly to verified recipients.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Built on trust, powered by blockchain technology, and designed for maximum impact
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-primary/10 to-primary-glow/10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8">
            Join thousands of verified donors and recipients creating positive change worldwide
          </p>
          <Button 
            size="lg" 
            onClick={() => navigate("/signup")}
      ...
      <footer className="border-t bg-card/50 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="flex items-center justify-center space-x-3 mb-4">
            ...
            <span className="text-lg font-bold text-foreground">GiveTrust</span>
          </div>
